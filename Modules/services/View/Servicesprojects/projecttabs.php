<div class="col-xs-12" style="border-bottom: 1px solid #e1e1e1; margin-bottom: 14px; padding-bottom: 7px;">
    ...
    <div class="col-sm-offset-3 col-sm-6 text-center">
        <div class="btn-group" data-toggle="buttons">
            ...
            <button class="btn btn-default <?php if($headerInfo["curentTab"] == "samplereturn"){echo "active";} ?>" type="button" onclick="location.href = 'servicesprojectsample/<?php echo $id_space."/".$headerInfo["projectId"] ?>'"><?php echo ServicesTranslator::Samples($lang) ?></button> 
