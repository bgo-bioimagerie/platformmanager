                    ...
                    <form class="form form-signin" action="corelogin" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-9">
                                <div class="d-flex align-items-center"><a href="corepasswordforgotten" class="m-3"><?php echo CoreTranslator::PasswordForgotten($language) ?></a></div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12 col-md-12">
                                <?php if(isset($pfm_support_url)) { ?>
                                <div class="d-flex justify-content-center"><a href="<?php echo $pfm_support_url ?>" class="btn btn-info" target="_blank"><?php echo CoreTranslator::Contact_support($language) ?></a></div>
                                <?php } elseif(isset($admin_email)) { ?>
                                <div class="d-flex justify-content-center"><a href="mailto:<?php echo $admin_email ?>" class="btn btn-info"><?php echo CoreTranslator::Contact_the_administrator($language) ?></a><?php echo $pfm_support_url ?></div>
                                <?php } ?>
                            </div>
                        </div>
                    </form>
