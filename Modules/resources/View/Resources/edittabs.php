<div class="col-xs-12">
    ...
    <div class="col-sm-offset-3 col-sm-6 text-center">
        <div class="btn-group" data-toggle="buttons">
            ...
            <button class="btn btn-default <?php if($headerInfo["curentTab"] == "resps"){echo "active";} ?>" type="button" onclick="location.href = 'resourcesresp/<?php echo $headerInfo["resourceId"] ?>'"><?php echo CoreTranslator::Responsible($lang) ?></button> 
