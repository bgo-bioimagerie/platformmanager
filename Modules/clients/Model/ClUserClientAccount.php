...
class ClUserClientAccount extends Model {

    public function __construct() {
        $this->tableName = "cl_j_user_client_accounts";
    ...
    public function getUsersForAccount($id_account) {
        $sql = "SELECT id_user FROM cl_j_user_client_accounts WHERE id_account=?";
        return $this->runRequest($sql, array($id_account))->fetchAll();
    }

    public function getUserAccount($id_space, $id_user) {
        $sql = "SELECT id_account FROM cl_j_user_client_accounts WHERE id_user=? AND id_account IN (SELECT id FROM es_client_accounts WHERE id_space=?)";
    ...
    public function set($id_user, $id_account) {
        if (!$this->exists($id_user, $id_account)) {
            $sql = 'INSERT INTO cl_j_user_client_accounts (id_user, id_account) VALUES (?,?)';
    ...
    public function exists($id_user, $id_account){
        $sql = "SELECT id FROM cl_j_user_client_accounts WHERE id_user=? AND id_account=?";
    ...
    public function delete($id) {
        $sql = "DELETE FROM cl_j_user_client_accounts WHERE id=?";
