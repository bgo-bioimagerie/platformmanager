...
class BkColorCode extends Model {
	 ...
	 */
	public function addColorCode($name, $color, $text_color, $id_site, $display_order=0){
		
		$sql = "insert into bk_color_codes(name, color, text, id_site, display_order)"
				. " values(?, ?, ?, ?, ?)";
		$this->runRequest($sql, array($name, $color, $text_color, $id_site, $display_order));		
	}
	 ...
	 */
	public function updateColorCode($id, $name, $color, $text_color, $id_site, $display_order){
		
		$sql = "update bk_color_codes set name=?, color=?, text=?, id_site=?, display_order=? where id=?";
		$this->runRequest($sql, array("".$name."", "".$color."", $text_color, $id_site, $display_order , $id));
	}
        ...
        public function editColorCode($id, $name, $color, $text_color, $id_site, $display_order){
            if($this->isColorCodeId($id)){
                ...
                $this->addColorCode($name, $color, $text_color, $id_site, $display_order);
            }
        }
