            ...
            <div class="form-group ">
                ...
                <div class="col-xs-10">
                    <select class="form-control" name="condition_et_ou" >
                        <OPTION value="and" <?php if (isset($condition_et_ou) && $condition_et_ou == 1) {
    echo "selected=\"selected\"";
} ?>> Valide toutes les conditions suivantes </OPTION>
                        <OPTION value="or" <?php if (isset($condition_et_ou) && $condition_et_ou == 0) {
    echo "selected=\"selected\"";
                ...
                <div class="col-xs-10">
                        ...
                        <div class="col-xs-4">
                            <select class="form-control" name="type_recherche[]" >
                                <OPTION value="1" <?php if (isset($type_recherche[$i]) && $type_recherche[$i] == 1) {
                                    echo "selected=\"selected\"";
                                } ?>> <?php echo BookingTranslator::Contains($lang) ?> </OPTION>
                                <OPTION value="0" <?php if (isset($type_recherche[$i]) && $type_recherche[$i] == 0) {
                            echo "selected=\"selected\"";
...
?>
                        <OPTION value="1" <?php if (isset($output) && $output == 1) {
    echo "selected=\"selected\"";
} ?>> Détails des réservations </OPTION>
                        <OPTION value="2" <?php if (isset($output) && $output == 2) {
    echo "selected=\"selected\"";
} ?>> Résumé statistique </OPTION>
                        <OPTION value="3" <?php if (isset($output) && $output == 3) {
                            echo "selected=\"selected\"";
                        } ?>> Détails des réservations et résumé </OPTION>
                        <OPTION value="4" <?php if (isset($output) && $output == 4) {
                            echo "selected=\"selected\"";
                        } ?>> Fichier CSV des réservations </OPTION>
                        <OPTION value="5" <?php if (isset($output) && $output == 5) {
                            echo "selected=\"selected\"";
        ...
        <table class="table table-striped text-center table-bordered">
            ...
            <thead> <!-- En-tête du tableau -->
                <tr>				
                    ...
                    <th><?php echo BookingTranslator::Date($lang) ?></th> 
