...
?>
			...
			<button type="button" class="btn btn-default"><a aria-label="current week" href="bookingweekarea/<?php echo "$id_space/$qt" ?>"> <?php echo  BookingTranslator::Today($lang) ?> </a></button>
        </div>            
        <?php
