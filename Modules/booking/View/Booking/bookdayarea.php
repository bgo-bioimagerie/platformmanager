...
$toDate = null;
$nbDays = 1;
$from = ["dayarea", $date, $bk_id_resource, $bk_id_area, $idUser, $detailedView ? 'detailed' : 'simple'];
...
echo drawNavigation('dayarea', $idSpace, $startDate, $toDate, $beforeDate, $afterDate, $bk_id_resource, $bk_id_area, $idUser, $detailedView, $lang);
if ($detailedView) {
