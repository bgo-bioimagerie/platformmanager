...
<button type="submit" class="btn btn-default" onclick="location.href='bookingweek/dayweekbefore'">&lt;</button>
<button type="submit" class="btn btn-default" onclick="location.href='bookingweek/dayweekafter'">></button>
<button type="submit" class="btn btn-default" onclick="location.href='bookingweek/thisWeek'"><?php echo  BookingTranslator::This_week($lang) ?></button>
    </div>
    <?php 
