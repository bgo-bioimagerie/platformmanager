...
?>
			<button type="button" class="btn btn-default"><a aria-label="previous week" href="bookingweek/<?php echo "$id_space/$qb" ?>"> &lt; </a></button>
			<button type="button" class="btn btn-default"><a aria-label="next week" href="bookingweek/<?php echo "$id_space/$qa" ?>"> > </a></button>
			<button type="button" class="btn btn-default"><a aria-label="current week" href="bookingweek/<?php echo "$id_space/$qt" ?>"> <?php echo  BookingTranslator::Today($lang) ?> </a></button>
		</div>
		<?php 
