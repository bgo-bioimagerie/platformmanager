...
class bookingpackagesController extends CoresecureController {
    ...
    public function indexAction() {
        ...
        $packages = $modelPackages->getAll("id_resource");
        $packagesIds = array(); $packagesIdsRes = array();
        $packagesNames = array(); $packagesDuration = array();
        ...
        $form->setValidationButton(CoreTranslator::Save($lang), "bookingpackages");
