...
class EsNotFeasibleReason extends Model {
    ...
    public function getAll($id_space) {
        $sql = "SELECT * FROM es_not_feasible_reason WHERE id_space=?";
        return $this->runRequest($sql, array($id_space))->fetchAll();
    }

    public function get($id) {
        $sql = "SELECT * FROM es_not_feasible_reason WHERE id=?";
        return $this->runRequest($sql, array($id))->fetch();
    }

    public function getName($id){
        $sql = "SELECT name FROM es_not_feasible_reason WHERE id=?";
    ...
    public function exists($name){
        $sql = "SELECT id FROM es_not_feasible_reason WHERE name=?";
    ...
    public function set($id, $id_space, $name) {
        if (!$id) {
            ...
            $sql = 'UPDATE es_not_feasible_reason SET id_space=?, name=? WHERE id=?';
