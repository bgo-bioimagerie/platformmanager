 ...
 */
class EstorenotfeasiblereasonsController extends CoresecureController {
    ...
    public function __construct(Request $request) {
        ...
        $this->model = new EsNotFeasibleReason ();
    }
    ...
    public function indexAction($id_space) {
        ...
        $table = new TableView();
        $table->addLineEditButton("esnotfeasiblereasonsedit/" . $id_space);
        $table->addDeleteButton("esnotfeasiblereasonsdelete/" . $id_space);
    ...
    public function editAction($id_space, $id) {
        ...
        $form->setTitle(EstoreTranslator::NotFeasibleReason($lang), 3);
        $form->addHidden("id", $pricing["id"]);
        $form->addText("name", CoreTranslator::Name($lang), true, $pricing["name"]);
        
        $form->setValidationButton(CoreTranslator::Ok($lang), "esnotfeasiblereasonsedit/" . $id_space . "/" . $id);
        $form->setCancelButton(CoreTranslator::Cancel($lang), "esnotfeasiblereasons/" . $id_space);
        ...
        if ($form->check()) {
            ...
            $this->redirect("esnotfeasiblereasonsedit/" . $id_space . "/" . $idNew);
        } else {
            // set the view
