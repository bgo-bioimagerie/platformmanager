 ...
 */
class BreedingpricingsController extends CoresecureController {
    ...
    public function __construct(Request $request) {
        ...
        $this->pricingModel = new BrPricing ();
    ...
    public function indexAction($id_space) {
        ...
        $table = new TableView();
        $table->addLineEditButton("brpricingedit/" . $id_space);
        $table->addDeleteButton("brpricingdelete/" . $id_space);
    ...
    public function editAction($id_space, $id) {
        ...
        $form->setTitle(BreedingTranslator::Edit_Pricing($lang), 3);
        $form->addHidden("id", $pricing["id"]);
        $form->addText("name", CoreTranslator::Name($lang), true, $pricing["name"]);
        
        $form->setValidationButton(CoreTranslator::Ok($lang), "brpricingedit/" . $id_space . "/" . $id);
        $form->setCancelButton(CoreTranslator::Cancel($lang), "brpricings/" . $id_space);
