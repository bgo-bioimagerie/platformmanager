...
class HelpdeskRouting extends Routing{
    ...
    public function routes($router) {
        ...
        $router->map('POST', '/helpdesk/[i:id_space]/[i:id_ticket]', 'helpdesk/helpdesk/update', 'helpdesk_ticket_update');
        $router->map('PUT', '/helpdesk/[i:id_space]/[i:id_ticket]', 'helpdesk/helpdesk/message', 'helpdesk_ticket_add_message');
