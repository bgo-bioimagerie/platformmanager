...
class CoreUpgradeDB1641978438 extends Model {
  public function run(){
    ...
    $pre_sql = "SET sql_mode = '';";
    $sql = $pre_sql . " alter table se_order modify column date_open date NULL";
    $this->runRequest($sql);
    ...
    $post_sql = "SET sql_mode = (SELECT @@GLOBAL.sql_mode);";
    $this->runRequest($sql . $post_sql);
